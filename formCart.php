...
<div class="ps-cart__listing">
    <div class="ps-cart__content">
        ...
        <div class="ps-cart-item"><a class="ps-cart-item__close" href="#"></a>
            ...
            <p><span>Giá:<i><?php echo $shoe['price'] - $shoe['price']*$shoe['sale']*0.01 ?> VND</i></span></p>
            </div>
        </div>
        <?php
        }
    ...
    <div class="ps-cart__total">
        <p>Số lượng:<span><?php echo $cartList->num_rows ?></span></p>
        <p>Tổng cộng:<span><?php echo $sumPrice ?> VND</span></p>
    </div>
