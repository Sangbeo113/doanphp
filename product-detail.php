            ...
            <div class="col-lg-10 col-md-12 col-lg-offset-1">
              ...
              <div class="ps-product__content mt-50">
                <ul class="tab-list" role="tablist">
                  <li class="active"><a href="#tab_01" aria-controls="tab_01" role="tab" data-toggle="tab">Giới Thiệu</a></li>
              ...
              <div class="tab-content mb-60">
                ...
                <div class="tab-pane" role="tabpanel" id="tab_02">
                  <p class="mb-20">1 đánh giá về <strong>Adidas thunder</strong></p>
                  <div class="ps-review">
                    ...
                    <div class="ps-review__content">
                      <header>
                        ...
                        <p><a href=""> Sang Béo</a> - 10 tháng 4, 2023</p>
                      </header>
                      <p>Giày đẹp.</p>
                    </div>
                  </div>
                  <form class="ps-product__review" action="_action" method="post">
                    ...
                    <div class="row">
                          ...
                          <div class="col-lg-8 col-md-8 col-sm-6 col-xs-12 ">
                            ...
                            <div class="form-group">
                              <button class="ps-btn ps-btn--sm">Gửi<i class="ps-icon-next"></i></button>
                            </div>
                          </div>
                    </div>
                  </form>
          ...
          <div class="ps-section__header mb-50">
            <div class="row">
                  <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 ">
                    <h3 class="ps-section__title" data-mask="Just Do It">- Sản Phẩm Tương tự</h3>
                  </div>
